...
local function computeUtilities(params,dbparams)
	...
	utility[1] = beta_cons_unusual + beta_INCOME_unusual * INCOME +
    beta_missingincome_unusual * missingincome + beta_missingage_unusual * missingage +
