--[[
Model: Tour Time of Day - Education
...
-- COEFFICIENTS
local beta_DUR_1 = 0.894
local beta_DUR_2 = 0.0445
local beta_DUR_3 = -0.00435

local beta_arr_1_cos2pi = -17.9
local beta_arr_1_cos4pi = -9.88
local beta_arr_1_cos6pi = -1.76
local beta_arr_1_sin2pi = -11.3
local beta_arr_1_sin4pi = -9.44
local beta_arr_1_sin6pi = -3.81

local beta_dep_1_cos2pi = -8.27
local beta_dep_1_cos4pi = -1.87
local beta_dep_1_cos6pi = 0.765
local beta_dep_1_sin2pi = -0.580
local beta_dep_1_sin4pi = -2.61
local beta_dep_1_sin6pi = -1.65

local beta_arr_tt = 0.0116
local beta_dep_tt = 0.0151

local beta_cost = -0.0386
