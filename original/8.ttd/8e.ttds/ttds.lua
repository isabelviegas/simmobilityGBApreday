...
local beta_arr_1_cos2pi = -5.38
local beta_arr_1_cos4pi = -1.04
local beta_arr_1_cos6pi = 0
local beta_arr_1_sin2pi = 3.04
local beta_arr_1_sin4pi = -1.07
local beta_arr_1_sin6pi = 0

local beta_dep_1_cos2pi = 3.20
local beta_dep_1_cos4pi = 0.840
local beta_dep_1_cos6pi = 0
local beta_dep_1_sin2pi = -4.72
local beta_dep_1_sin4pi = 0.0202
