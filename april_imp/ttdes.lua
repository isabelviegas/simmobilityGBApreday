--[[
Model - Tour time of day for escort tour
Type - MNL
...
local beta_arr_1_cos2pi = -5 -- -5.20
local beta_arr_1_cos4pi = -1.68             -0.1 -- -1.68
local beta_arr_1_cos6pi = 0.204  -- 0.204
local beta_arr_1_sin2pi = 1.5 +1+0.1+0.1+0.1   -- 0.5  -- 2.58
local beta_arr_1_sin4pi = -0.5 -- -1.41
local beta_arr_1_sin6pi = -0.534  -- -0.534

local beta_dep_1_cos2pi = -5 -- 2.79
local beta_dep_1_cos4pi = -1.68             -0.1  -- 0.654
local beta_dep_1_cos6pi = 0.204  -- 0.623
local beta_dep_1_sin2pi = 1.5 +1+0.1+0.1+0.1  -- 0.5  -- -4.12
local beta_dep_1_sin4pi = -0.5 -- -0.299
local beta_dep_1_sin6pi = -0.534  -- -0.236
...
local function sarr_1(t)
	return beta_arr_1_sin2pi * math.sin(2*pi*t/24.) + beta_arr_1_cos2pi * math.cos(2*pi*(t+3)/32) + beta_arr_1_sin4pi * math.sin(4*pi*t/24.) + beta_arr_1_cos4pi * math.cos(4*pi*t/24.) + beta_arr_1_sin6pi * math.sin(6*pi*t/24.) + beta_arr_1_cos6pi * math.cos(6*pi*t/24.)
end

local function sdep_1(t)
	return beta_dep_1_sin2pi * math.sin(2*pi*t/24.) + beta_dep_1_cos2pi * math.cos(2*pi*(t+3)/32) + beta_dep_1_sin4pi * math.sin(4*pi*t/24.) + beta_dep_1_cos4pi * math.cos(4*pi*t/24.) + beta_dep_1_sin6pi * math.sin(6*pi*t/24.) + beta_dep_1_cos6pi * math.cos(6*pi*t/24.)
end
