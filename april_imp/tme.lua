...
--print("tme is called\n")
local cons_walk = -1.356
local cons_bike = -1.88
local cons_drive1 = -0.5
local cons_share2 = -0.59
local cons_share3 = -1.04
local cons_PT = 0.114
local cons_OD = -4.5
local cons_PR = cons_PT-2.2
...
local beta_central_OD = beta_central_PT
local beta_central_PR = beta_central_PT
...
local beta_LIC_PT = 0
local beta_LIC_OD = beta_LIC_PT
local beta_LIC_PR = beta_LIC_drive1
...
local beta_TRANS_OD = beta_TRANS_drive1
...
local function computeUtilities(params,dbparams)
	...
	-- utility[7] = cons_OD + beta_tt_car * tt_car + beta_central_OD * CBD + beta_parttime_OD * parttime +
	...
	-- beta_TRANS_OD * TRANS +
	-- beta_cost_car * costCar/1.5 +
	-- beta_zerocar_OD * zerocar +
	...
	utility[8] = cons_PR + beta_tt_car * tt_PR_car + beta_tt_PT*tt_PR_PT+  beta_central_PR * CBD +
	beta_LIC_PR * LIC +
	beta_TRANS_PR * TRANS +
	beta_cost_PT * cost_PR_PT + beta_cost_car * cost_PR_car +
	beta_zerocar_PR * zerocar +
	beta_onecar_PR * onecar + beta_twocar_PR * twocar +
	beta_threepluscar_PR * threepluscar 
	-- print("tme utilities: 1: ", utility[1], " 2:", utility[2], " 3:", utility[3], " 4:", utility[4], " 5:", utility[5], " 6:", utility[6])
end
...
local function computeAvailabilities(params,dbparams)
	...
	-- print("tme availabilities: 1: ", availability[1], " 2:", availability[2], " 3:", availability[3], " 4:", availability[4], " 5:", availability[5], " 6:", availability[6])
end
