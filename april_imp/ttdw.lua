...
local beta_DUR_1 = -0.732
local beta_DUR_2 = 0.140
local beta_DUR_3 = -0.00809

local beta_arr_1_cos2pi = -1.04       -- -2.24
local beta_arr_1_cos4pi = -0.232      -- -0.932
local beta_arr_1_cos6pi = 1.056 -0.1   -- 0.356
local beta_arr_1_sin2pi = 1.72        -- 1.02
local beta_arr_1_sin4pi = -0.25       -- -1.05
local beta_arr_1_sin6pi = -0.212      -- -0.412

local beta_dep_1_cos2pi = -0.5       --0.385
local beta_dep_1_cos4pi = 0.46  --0.810
local beta_dep_1_cos6pi = -0.082       --0.232
local beta_dep_1_sin2pi = -1.28      -0.3  -- -2.58
local beta_dep_1_sin4pi = 0.566       --0.166
local beta_dep_1_sin6pi = 0.75 +0.1  --0.623

local beta_arr_tt = 0.00247
local beta_dep_tt = -0.00107

local beta_cost = -0.0337
