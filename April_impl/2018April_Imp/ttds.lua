--[[
Model - Tour time of day for shop  tour
Type - MNL
...
local beta_DUR_1 = -1.01
local beta_DUR_2 = -0.419
local beta_DUR_3 = 0.0197

local beta_arr_1_cos2pi = -2.3 - 0.2 -- -1
local beta_arr_1_cos4pi = 0.3  - 0.2    -- 1.5
local beta_arr_1_cos6pi = 0.6  - 0.2-0.1  
local beta_arr_1_sin2pi = 0
local beta_arr_1_sin4pi = -0.6+0.3
local beta_arr_1_sin6pi = 0

local beta_dep_1_cos2pi = -2.3 - 0.2 -- -1
local beta_dep_1_cos4pi = 0.3  - 0.2    -- 1.5
local beta_dep_1_cos6pi = 0.6  - 0.2-0.1
local beta_dep_1_sin2pi = 0
local beta_dep_1_sin4pi = -0.6+0.3
local beta_dep_1_sin6pi = 0

local beta_arr_tt = 0
local beta_dep_tt = -0.0179

local beta_cost = 0.0640
...
local function sarr_1(t)
	t = t-1 --t+1  -- t+2
	return beta_arr_1_sin2pi * math.sin(2*pi*t/24.) + beta_arr_1_cos2pi * math.cos(2*pi*(t+6)/36) + beta_arr_1_sin4pi * math.sin(4*pi*t/24.) + beta_arr_1_cos4pi * math.cos(4*pi*(t+5)/36) + beta_arr_1_sin6pi * math.sin(6*pi*t/24) + beta_arr_1_cos6pi * math.cos(6*pi*(t+6)/36)
end

local function sdep_1(t)
	t = t-1  -- t+1      --t+2
	return beta_dep_1_sin2pi * math.sin(2*pi*t/24.) + beta_dep_1_cos2pi * math.cos(2*pi*(t+6)/36) + beta_dep_1_sin4pi * math.sin(4*pi*t/24.) + beta_dep_1_cos4pi * math.cos(4*pi*(t+5)/36) + beta_dep_1_sin6pi * math.sin(6*pi*t/24.) + beta_dep_1_cos6pi * math.cos(6*pi*(t+6)/36)
end
...
function choose_ttds(params,dbparams)
