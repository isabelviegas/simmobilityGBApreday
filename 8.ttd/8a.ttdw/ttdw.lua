...
local beta_arr_1_cos2pi = -2.24
local beta_arr_1_cos4pi = -0.932
local beta_arr_1_cos6pi = 0.356
local beta_arr_1_sin2pi = 1.02
local beta_arr_1_sin4pi = -1.05
local beta_arr_1_sin6pi = -0.412

local beta_dep_1_cos2pi = 0.385
local beta_dep_1_cos4pi = 0.810
local beta_dep_1_cos6pi = 0.232
local beta_dep_1_sin2pi = -2.58
local beta_dep_1_sin4pi = 0.166
local beta_dep_1_sin6pi = 0.623
